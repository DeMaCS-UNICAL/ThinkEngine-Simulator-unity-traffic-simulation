...
namespace TrafficSimulation{
    ...
    {   
        ...
        public List<Segment> lightsNbr1; //used as Sensor
        public List<Segment> lightsNbr2; //used as Sensor

        private List<GameObject> vehiclesQueue;
        private List<GameObject> vehiclesInIntersection;
        private TrafficSystem trafficSystem;
        public int toSetRed=1; //used by actuator
        public int lastFrameSwitch;
        public int frame;
        ...
        void Start(){
            ...
            if(toSetRed==-1 && intersectionType == IntersectionType.TRAFFIC_LIGHT)
        ...
        void CheckLights()
        {
            if (currentRedLightsGroup != toSetRed)
            {
                lastFrameSwitch = frame;
                currentRedLightsGroup = toSetRed;
